const CardIt = ({ name, price, photo, user, userImage, duration, hashtag }) => {
    ...
    const coinIcons = Array.from({ length: price }, (_, index) => (
        <svg
            key={index}
            className="w-6 h-6 text-center fill-yellow-500 inline"
            ...
            <div className="mb-6 flex items-center justify-center gap-x-6">
                <div>
                    <div className="flex mt-6">
                        <button className="flex w-20 justify-center py-1 rounded-tl-full rounded-bl-full border-2 border-indigo-600 bg-white ">
                        ...
                        <div className="flex w-20 items-center justify-center bg-indigo-600 p-2 rounded-tr-full rounded-br-full text-white font-semibold ">0
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex mt-6">
                        <div className="flex w-20 items-center justify-center p-2 rounded-tl-full rounded-bl-full bg-indigo-600  border-indigo-600 text-white font-semibold">
                            View
                        </div>

                        <button className="flex w-20 items-center justify-center  rounded-tr-full rounded-br-full border-2 border-indigo-600  font-semibold ">more
