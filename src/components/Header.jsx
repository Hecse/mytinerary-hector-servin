                ...
                <div className="hidden items-center md:flex lg:gap-x-10 md:gap-x-4">
                    ...
                    {links ? links.map((link, i) => (
                        <Link
                            key={i}
                            to={link.to}
                            className="text-md font-semibold leading-6 text-gray-900 transition border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-indigo-600 duration-300">{link.title}
                        </Link>))
                        : null}
                            ...
                            <div className="space-y-2 py-6">
                                {links ? links.map((link, i) => (
                                    <Link
                                        ...
                                        to={link.to}
                                        onClick={() => setMobileMenuOpen(false)}
                                        className="-mx-3 block rounded-lg px-3 py-2 text-base text-center font-semibold leading-7 text-gray-900 hover:bg-indigo-300">{link.title}
                                    </Link>))
                                    : null}
                            </div>
                            {user ?
                                <Link
                                    ...
                                    onClick={() => dispatch(userlogout())}>Sign Out
                                </Link>
                                : null}
                        </div>
                    </div>
