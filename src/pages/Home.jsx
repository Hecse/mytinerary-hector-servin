...
const Home = () => {
    return (
        <div>
            <div>
                <img
                    className="object-none h-72 w-full "
                    src="./assets/images/puerto-madero.jpg"
                    alt="Puerto Madero"
                />
            </div>
            ...
            <div className="px-6 lg:px-8">
                <div>
                    <div className="text-center">
                        <p
                            className="font-bold text-gray-600 bg-gradient-to-t text-6xl font-[audiowide-regular]">
                            <span
                                className='bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 text-transparent bg-clip-text'>
                                MyTinerary
                            </span>
                        </p>

                        <p
                            className="mt-8 text-lg text-gray-800 font-bold">
                            Find your perfect trip, designed by insiders who know and love their cities!
                        </p>

                        <p
                            className="mt-4 text-base leading-6 text-gray-800">
